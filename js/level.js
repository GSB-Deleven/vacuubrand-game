...
// Gegner:   Zone 1 Filtration: d Filtrat-Tropfen  f Schmutzpartikel  p Filterpapier  s SPE-Kartusche
...
//                              k Rundkolben  h Trockenschrank-Hitze  m Messbecher  o Lösemittelfass
...
const Level = {
  ...
  build() {
    ...
    q(26, 6, '?');
    e('p', 29, 6); q(31, 6, '1'); e('s', 33);
    lan(35, 7, 5); e('d', 36, 6); e('s', 38, 6);
    q(37, 3, '?');
    pit(43, 44);
    ...
    sign(170, 'LÖSEMITTELFASS?\nDAFÜR BRAUCHT ES\nDIE VACUU·PURE!');
    e('o', 172);
    brick(174, 9); brick(175, 8, 1, 2); brick(176, 7, 1, 3);
    e('v', 176, 2);
    e('h', 180, 6); e('k', 183); brick(185, 6); q(186, 6, 'V'); brick(187, 6);
    e('m', 189); brick(192, 6); q(193, 6, '3'); brick(194, 6);
    e('r', 196); e('c', 198, 6);

    // ---------------- Zone 4: HOCHVAKUUM-TECHNIKUM (VACUU·PURE 10C) ----------------
    sign(202, 'VACUU·PURE 10C: GEFRIER-\nTROCKNUNG, SCHLENK, TURBO');
    q(205, 6, '3');
